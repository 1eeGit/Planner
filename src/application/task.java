...
public class task {
		private int taskID; private String taskName; private String taskDsc; private boolean taskStatus; private int taskStime; private int taskEtime; private double taskRate; private int taskRelatedAct;

		public task(int taskID, String taskName, String taskDsc, boolean taskStatus, int taskStime, int taskEtime,
